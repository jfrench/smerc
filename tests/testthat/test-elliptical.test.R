...
# })
context("assess accuracy of elliptic.test")
...
test_that("check accuracy for elliptical.test a = 0", {
  ...
  # expect_equal(30, out0$clusters[[5]]$angle - 90)
...
locids0.51 = c(52, 50, 53, 38, 49, 15, 48, 39, 1, 37, 16, 44, 14, 47, 40, 2, 13, 43,
               51, 45, 17, 11, 12, 3, 46)
locids0.52 = c(87, 88, 86, 89, 92, 85, 90)
locids0.53 = c(115, 116, 114, 111, 117, 113, 123, 120, 110, 122, 112, 118, 121, 124,
...
locids1.1 = c(52, 50, 53, 38, 49, 15, 48, 39, 1, 37, 16, 44, 14, 47, 40, 2, 13, 43,
              51, 45, 17, 11, 12, 3, 46)
locids1.7 = c(106, 103, 102, 77, 230)
...
test_that("check accuracy for elliptical.test a = 1", {
  ...
  expect_equal(14.181797, round(out1$clusters[[1]]$test_statistic, 6))
