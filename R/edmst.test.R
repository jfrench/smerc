#' Early stopping dynamic minimum spanning tree scan test
#' 
...
#' resulting likelihood ratio test statistic.  This is 
#' procedure is repeated until adding a connected region
#' does not rease the test statistic (or the population or distance 
#' upper
