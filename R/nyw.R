#' @name nyw
#' @title Adjacency matrix for New York leukemia data.
#' @description This data set contains a 281 x 281 adjacency matrix for the New York leukemia data in \code{nydf}.
#'
#' @docType data
#' @usage data(nyw)
#'
#' @format A matrix of dimension 281 x 281.
