...
#' 
#' \code{smst_max_zone} finds the sequence of connected regions that maximize the likelihood from a starting region.  The sequence continues until no region can be added to the current zone due to constraints.
#' 
